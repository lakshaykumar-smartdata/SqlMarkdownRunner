...
- **Run SQL** page → pick a connection, run, copy/download the markdown. The side panel lists the database's tables, views, procedures and functions; drag a name into the editor.
